(function(){
	...
	.controller('newExperienceController', newExperienceController)

	newExperienceController.$inject = ["$scope", "$http"];

	function newExperienceController($scope, $http){
		var that = this;
		...
		function disableInputs(){
			...
			function uploadVideo(file){
				var metadata = {
					snippet: {
						title: $('#id_title').val().substring(0, 40),
